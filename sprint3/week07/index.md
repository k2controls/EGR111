...
- Week 06 Review
  - solar_panel V2 - refactored to include functions
    - parameters, arguments, return type, return value
  - rgb_convert_w_functions
    - declaration vs definition
  - chkr_get_player
    - variable scope: local vs global
  - max_of_three revisted
    - void function with pointer
  - car_warranty.c
    - use of stubs
    - sample implementation of *bool has_extended_warranty()*
  
- more function review
  - [functions.c](functions.c)
  - wget https://k2controls.github.io/EGR111/sprint3/week07/functions.c
