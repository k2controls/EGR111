// Solar Panel Calculator - Version 3.0
...
const int SIDEWALL_MIN = 30;    //feet
const int SIDEWALL_MAX = 120;   //feet
const int ENDWALL_MIN = 20;     //feet
const int ENDWALL_MAX = 60;     //feet
