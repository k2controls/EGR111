...
**Session 1**
- week 03 Review
  - Pushing EGR111 repo to remote GitHub
    - issues?
    - plan/resolution? You must be working with Keith to resolve.
...
- Code Review
  - copy week02 code to week04. Modify your week04 code based on class review.
  - grocery_bill.c
  - time_convert.c
